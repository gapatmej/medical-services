...
public class Fichero {
            ...
            if (file.exists() && file.isFile()) {
                if (
                    ...
                    javax.swing.JOptionPane.showConfirmDialog(
                        null,
                        "El archivo será sobrescrito. Desea continuar?",
                        "Confirmacion",
    ...
    public static void abrirFichero(String rutaFichero) {
        ...
        if (java.awt.Desktop.isDesktopSupported() == true) {
            ...
            try {
                if (archivo.exists() == true) {
                    ...
                    javax.swing.JOptionPane.showMessageDialog(
                        null,
                        "No se encontrar el archivo: " + archivo.getAbsolutePath(),
                        "Aviso",
            ...
            javax.swing.JOptionPane.showMessageDialog(
                null,
                "No se puede ejecutar el comando de apertura en este sistema operativo",
                "Aviso",
                javax.swing.JOptionPane.WARNING_MESSAGE
            );
        }
    ...
    public static void ficheros(
        String pathInicial,
        String mascara,
        java.util.LinkedList<java.io.File> listaFicheros,
