...
class OOXMLXAdESSigner {
     ...
     * XML.
     */
    static byte[] getSignedXML(byte[] ooXmlDocument, String algorithm, PrivateKey pk, X509Certificate[] certChain, Properties xParams)
        throws ParserConfigurationException, GeneralSecurityException, IOException, SAXException, MarshalException, XMLSignatureException {
        ...
        xmlSignature.addXMLObject(
            OOXMLPackageObjectHelper.getPackageObject(ID_PACKAGE_OBJECT, fac, ooXmlDocument, docSignature, signatureId)
        );
        referenceList.add(fac.newReference("#" + ID_PACKAGE_OBJECT, digestMethod, null, "http://www.w3.org/2000/09/xmldsig#Object", null));
        ...
        referenceList.add(fac.newReference("#" + ID_OFFICE_OBJECT, digestMethod, null, "http://www.w3.org/2000/09/xmldsig#Object", null));
    ...
    private static void writeXMLwithXALAN(Writer writer, Node node, String xmlEncoding) {
        LSSerializer serializer = ((DOMImplementationLS) node.getOwnerDocument().getImplementation()).createLSSerializer();
    ...
    private static SignatureProductionPlace getSignatureProductionPlace(String city, String province, String postalCode, String country) {
