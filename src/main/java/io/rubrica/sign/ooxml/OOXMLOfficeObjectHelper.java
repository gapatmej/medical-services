...
class OOXMLOfficeObjectHelper {
    ...
    static XMLObject getOfficeObject(
        String nodeId,
        ...
        if (signatureComments != null) {
            Element signatureCommentsElement = document.createElementNS(MS_DIGITAL_SIGNATURE_SCHEMA, "SignatureComments");
        ...
        Element horizontalResolutionElement = document.createElementNS(MS_DIGITAL_SIGNATURE_SCHEMA, "HorizontalResolutionElement");
        ...
        Element verticalResolutionElement = document.createElementNS(MS_DIGITAL_SIGNATURE_SCHEMA, "VerticalResolutionElement");
        ...
        signatureInfoV1Element.appendChild(document.createElementNS(MS_DIGITAL_SIGNATURE_SCHEMA, "SignatureProviderUrl"));

        Element signatureProviderDetails = document.createElementNS(MS_DIGITAL_SIGNATURE_SCHEMA, "SignatureProviderDetails");
        ...
        SignatureProperty signatureInfoSignatureProperty = fac.newSignatureProperty(
