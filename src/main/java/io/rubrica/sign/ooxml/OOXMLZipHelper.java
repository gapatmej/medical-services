...
class OOXMLZipHelper {
    ...
    static byte[] outputSignedOfficeOpenXMLDocument(final byte[] ooXmlDocument, final byte[] xmlSignatureFile)
        ...
        try (final ZipOutputStream zipOutputStream = copyOOXMLContent(ooXmlDocument, signatureZipEntryName, signedOOXMLOutputStream);) {
    ...
    private static ZipOutputStream copyOOXMLContent(
        ...
        try (final ZipInputStream zipInputStream = new ZipInputStream(new ByteArrayInputStream(ooXmlDocument));) {
            ...
            while (null != (zipEntry = zipInputStream.getNextEntry())) {
                ...
                if ("[Content_Types].xml".equals(zipEntry.getName())) {
                    ...
                    if (0 == nodeList.getLength()) {
                        final Element relationshipElement = relsDocument.createElementNS(RELATIONSHIPS_SCHEMA, "Relationship");
                    ...
                    final Element relationshipElement = originSignRelsDocument.createElementNS(RELATIONSHIPS_SCHEMA, "Relationship");
    ...
    private static void addOriginSigsRels(final String signatureZipEntryName, final ZipOutputStream zipOutputStream)
        ...
        final Element relationshipsElement = originSignRelsDocument.createElementNS(RELATIONSHIPS_SCHEMA, "Relationships");
    ...
    static void writeDocumentNoClosing(final Document document, final OutputStream documentOutputStream, final boolean omitXmlDeclaration)
