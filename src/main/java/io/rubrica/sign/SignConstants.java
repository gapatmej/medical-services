...
public final class SignConstants {
    ...
    public static String getDigestAlgorithmName(final String pseudoName) {
        ...
        if (
            upperPseudoName.equals("http://www.w3.org/2001/04/xmlenc#sha256".toUpperCase(Locale.US)) ||
        ...
        if (
            upperPseudoName.startsWith("SHA384") ||
        ...
        if (
            upperPseudoName.equals("http://www.w3.org/2001/04/xmlenc#sha512".toUpperCase(Locale.US)) ||
        ...
        if (
            upperPseudoName.equals("http://www.w3.org/2001/04/xmlenc#ripemd160".toUpperCase(Locale.US)) ||
    ...
    public static boolean isSHA2SignatureAlgorithm(final String algorithm) {
        return (
            SIGN_ALGORITHM_SHA256WITHRSA.equals(algorithm) ||
