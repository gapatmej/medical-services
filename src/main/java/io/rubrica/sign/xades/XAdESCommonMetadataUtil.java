...
final class XAdESCommonMetadataUtil {
    ...
    static void addCommonMetadata(final XAdES_EPES xades, final Properties extraParams) throws RubricaException {
        ...
        try {
            ...
            throw new RubricaException(
                "El algoritmo indicado para la politica (" +
    ...
    private static SignatureProductionPlace getSignatureProductionPlace(
        final String city,
    ...
    private static SignaturePolicyIdentifier getPolicy(
        final String id,
        ...
        try {
            logger.warning(
                "Se proporciono directamente un OID como identificador de politica (" +
                new Oid(id) +
        ...
        try {
            ...
            logger.warning(
                "No se ha podido acceder al identificador ('" + identifier + "') de la politica de firma, no se anadira este campo: " + e
            );
            return null;
        }
