            ...
            if ("sun.security.mscapi.KeyStore$MY".equals(keyStoreVeritable.getClass().getName())) {
                ...
                for (Object entry : entries) {
                    ...
                    if (keyUsage[0]) {
                        ...
                        PrivateKeyAndCertificateChain p = new PrivateKeyAndCertificateChain(alias + " - " + i++, key, certificates);
                        privateKeys.add(p);
                    }
                }
            }

            return (PrivateKeyAndCertificateChain[]) privateKeys.toArray(new PrivateKeyAndCertificateChain[privateKeys.size()]);
