...
public class CrlUtils {
    ...
    public static ValidationResult verifyCertificateCRLs(
        X509Certificate cert,
        PublicKey vaPublicKey,
        List<String> overridingDistributionPoints
    ) throws RubricaException, EntidadCertificadoraNoValidaException {
        if (cert == null) {
        ...
        try {
            ...
            crlDistPoints =
                overridingDistributionPoints == null || overridingDistributionPoints.isEmpty()
        ...
        logger.fine("El certificado con serie '" + cert.getSerialNumber() + "' tiene asociadas las siguientes CRL: " + crlDistPoints);
        ...
        for (String crlDP : crlDistPoints) {
            ...
            try {
                ...
                logger.severe(
                    "No se ha podido descargar la CRL (" + crlDP + "), se continuara con el siguiente punto de distribucion: " + e
                );
                cannotDownload = true;
                continue;
            }
