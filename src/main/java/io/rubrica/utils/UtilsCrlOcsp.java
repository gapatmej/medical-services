...
public class UtilsCrlOcsp {
     ...
     */
    public static String validarCertificado(X509Certificate cert)
        throws EntidadCertificadoraNoValidaException, IOException, RubricaException, ConexionValidarCRLException, CRLValidationException {
    ...
    private static String validarCRL(X509Certificate cert)
        throws IOException, EntidadCertificadoraNoValidaException, RubricaException, ConexionValidarCRLException, CRLValidationException {
        ...
        result = crlUtils.verifyCertificateCRLs(cert, root.getPublicKey(), Arrays.asList(urlCrl));
