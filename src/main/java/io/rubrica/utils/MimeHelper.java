...
public final class MimeHelper {
    ...
    public MimeHelper(final byte[] data) {
        ...
        try {
            final Method getMagicMatchMethod = Class
                .forName("net.sf.jmimemagic.Magic")
            ...
            String mt = (String) magicMatchClass.getMethod("getMimeType", (Class[]) null).invoke(magicMatchObject, (Object[]) null);
            if (mt != null && UNKNOWN_JMIMEMAGIC_VALUE.equals(mt)) {
                mt = null;
            }
            this.mimeInfo.setMimeType(mt);
            String ext = (String) magicMatchClass.getMethod("getExtension", (Class[]) null).invoke(magicMatchObject, (Object[]) null);
            if (ext != null && UNKNOWN_JMIMEMAGIC_VALUE.equals(ext)) {
                ext = null;
            }
            this.mimeInfo.setExtension(ext);
            String desc = (String) magicMatchClass.getMethod("getDescription", (Class[]) null).invoke(magicMatchObject, (Object[]) null);
            ...
            try {
                final Class<?> magicMatchNotFoundException = Class.forName("net.sf.jmimemagic.MagicMatchNotFoundException");
    ...
    private static void loadOidMimetypeProperties() throws IOException {
        ...
        final InputStream isProp = MimeHelper.class.getClassLoader().getResourceAsStream("mimetypes_oids.properties");
        if (isProp == null) {
