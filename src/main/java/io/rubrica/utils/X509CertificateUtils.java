    ...
    public boolean validarX509Certificate(X509Certificate x509Certificate)
        ...
        if (x509Certificate != null) {
            ...
            if (fechaHora.compareTo(x509Certificate.getNotBefore()) <= 0 || fechaHora.compareTo(x509Certificate.getNotAfter()) >= 0) {
                ...
                java.util.Calendar calendarRecordatorio = java.util.Calendar.getInstance(
                ...
                if (calendarRecordatorio.getTime().compareTo(fechaHora) <= 0) {
                    ...
                    javax.swing.JOptionPane.showMessageDialog(
                        null,
                        PropertiesUtils.getMessages().getProperty("mensaje.advertencia.certificado_advertencia") +
                        simpleDateFormat.format(x509Certificate.getNotAfter().getTime()),
                        "Advertencia",
